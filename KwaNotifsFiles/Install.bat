...
if defined missing_pak_files (
    ...
    copy "%SOURCE_DIR%\%RENAME%.pak" "%~dp0..\Release\KwaNotificationsRelease\OblivionRemastered\Content\Paks\LogicMods\KwaNotificationsBP_P"
    copy "%SOURCE_DIR%\%RENAME%.ucas" "%~dp0..\Release\KwaNotificationsRelease\OblivionRemastered\Content\Paks\LogicMods\KwaNotificationsBP_P"
    copy "%SOURCE_DIR%\%RENAME%.utoc" "%~dp0..\Release\KwaNotificationsRelease\OblivionRemastered\Content\Paks\LogicMods\KwaNotificationsBP_P"
...
if defined missing_lua_file (
    ...
    copy "%SOURCE_DIR_LUA%\%LUA_NAME%" "%~dp0..\Release\KwaNotificationsRelease\OblivionRemastered\Binaries\Win64\ue4ss\mods\KwaNotificationsLua\Scripts"
