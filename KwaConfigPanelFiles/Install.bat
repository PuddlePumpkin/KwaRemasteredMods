...
set "DEST_DIR=C:\Program Files (x86)\Steam\steamapps\common\Oblivion Remastered\OblivionRemastered\Content\Paks\LogicMods\KwaConfigPanelBP_P"
...
:: Your Lua Mod Directory
set "DEST_DIR_LUA=C:\Program Files (x86)\Steam\steamapps\common\Oblivion Remastered\OblivionRemastered\Binaries\Win64\ue4ss\mods\KwaConfigPanelLua\Scripts"
::Your lua mod name
...
if defined missing_pak_files (
    ...
    copy "%SOURCE_DIR%\%RENAME%.pak" "%~dp0..\Release\KwaConfigPanelRelease\OblivionRemastered\Content\Paks\LogicMods\KwaConfigPanelBP_P"
    copy "%SOURCE_DIR%\%RENAME%.ucas" "%~dp0..\Release\KwaConfigPanelRelease\OblivionRemastered\Content\Paks\LogicMods\KwaConfigPanelBP_P"
    copy "%SOURCE_DIR%\%RENAME%.utoc" "%~dp0..\Release\KwaConfigPanelRelease\OblivionRemastered\Content\Paks\LogicMods\KwaConfigPanelBP_P"
...
if defined missing_lua_file (
    ...
    copy "%SOURCE_DIR_LUA%\%LUA_NAME%" "%~dp0..\Release\KwaConfigPanelRelease\OblivionRemastered\Binaries\Win64\ue4ss\mods\KwaConfigPanelLua\Scripts"
