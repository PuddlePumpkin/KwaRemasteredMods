#include "BethesdaNetUIScreenLogin.h"

UBethesdaNetUIScreenLogin::UBethesdaNetUIScreenLogin() {
}
...
void UBethesdaNetUIScreenLogin::LoginButtonClicked(const FText& UserName, const FText& Password) {
}
